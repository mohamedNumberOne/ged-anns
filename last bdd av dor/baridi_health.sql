...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 11 oct. 2023 à 00:45
...
(48, 'ref13', 'sujt 000000', '2023-10-10 23:42:48', '2023-10-07 00:00:00', 3, 'messaaaaaaaaaaaaage .  ..');
...
(23, 48, 7, NULL, 3, 0, 0, 1, 0, 0, 1, 1, '2023-10-10 23:43:10', '2023-10-10 23:42:48');
...
(10, 48, 'courriers/2023-10-10 23-42-48.png');
...
--
-- Déchargement des données de la table `repenses`
--

INSERT INTO `repenses` (`id_rep`, `id_cour`, `id_user`, `txt_rep`) VALUES
(5, 48, 2, 'Bien reçu!');
...
(2, 'kamal', 'amrani', 'm@gmail.com', '$2y$10$oaPXDVV4XcBMx/Hla7UKeusOVq9RZZ3OkLMqD7.tHgT0f6F37x9/2', 'post', 1, 7),
(3, 'nassim', 'mohamed', 'n@gmail.com', '$2y$10$oaPXDVV4XcBMx/Hla7UKeusOVq9RZZ3OkLMqD7.tHgT0f6F37x9/2', NULL, 1, 3);
...
--
ALTER TABLE `courriers`
  MODIFY `id_cour` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT pour la table `envoyer`
--
ALTER TABLE `envoyer`
  MODIFY `id_env` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT pour la table `fichiers_cour`
--
ALTER TABLE `fichiers_cour`
  MODIFY `id_fichier_cour` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `repenses`
  MODIFY `id_rep` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
